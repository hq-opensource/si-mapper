...
\textbf{The new business modes.}
The ASHRAE 223P model can unlock new business modes for aggregators and building owners. For example,
...
within agreed comfort and reliability bounds during grid events.'' In this example, 
