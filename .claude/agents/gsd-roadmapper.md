...
Reference full template: `/home/juan/codes/si-mapper/.claude/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `/home/juan/codes/si-mapper/.claude/get-shit-done/templates/state.md`.
