...
- **Global scope**: `/home/juan/codes/si-mapper/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/home/juan/codes/si-mapper/.claude/notes/`)
...
2. Glob `/home/juan/codes/si-mapper/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/home/juan/codes/si-mapper/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/home/juan/codes/si-mapper/.claude/notes/` — works in any directory
