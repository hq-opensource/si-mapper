...
def apply_bacnet(entity, bacnet_dict, prop_name=""):
    ...
    if match:
        ...
        if suffix in tmap:
            ...
            if type(entity).__name__.endswith("Sensor"):
                if hasattr(entity, "observedProperty"):
                    entity.observedProperty @ BACnetExternalReference(bacnet_uri)
                elif hasattr(entity, "observes"):
                    entity.observes @ BACnetExternalReference(bacnet_uri)
                else:
