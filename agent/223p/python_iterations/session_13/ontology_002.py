...
valve_cc_1 = ThreeWayMixingSystem(label="VALVE-CC-1")
...
damper_melange.airOutlet >> filter_1.airInlet  # Mixed air into filter

# Supply
damper_paf1.airOutlet >> filter_1.airInlet
damper_paf2.airOutlet >> filter_1.airInlet
