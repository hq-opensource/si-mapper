...
humidity_property_1 = RelativeHumidity(label="RH_USrSIXZqio")
humidity_property_1.hasUnit = UNIT.PERCENT
...
pressure_property_1 = DifferentialStaticPressure(label="DSP_cM7fhnE8Ef")
pressure_property_1.hasUnit = UNIT.PA
...
humidity_property_2 = RelativeHumidity(label="RH_z6b5HCekeB")
humidity_property_2.hasUnit = UNIT.PERCENT
...
pressure_property_2 = DifferentialStaticPressure(label="DSP_m9cuOHLBiE")
pressure_property_2.hasUnit = UNIT.PA
