...
class EquipmentLlmAgent(LoopWrapper):
    """
    Public Interface: Loop-wrapped Equipment Agent.
    """
    def __init__(self, model_name: str, tools: list[Any] = None, session_id: str = None):
        internal_agent = EquipmentLlmAgentInternal(
        ...
        super().__init__(
            ...
            description="Places HVAC equipment.",
            max_iterations=10
        )
